...
public interface TweenModelBuilder<IAnimation> {
   ...
   */
  TweenModelBuilder<IAnimation> addOval(
      String name,
      float cx, float cy,
   ...
   * @return the builder object
   */
  TweenModelBuilder<IAnimation> addRectangle(
      String name,
      float lx, float ly,
   ...
   */
  TweenModelBuilder<IAnimation> addMove(
      String name,
   ...
   */
  TweenModelBuilder<IAnimation> addColorChange(
      String name,
   ...
   */
  TweenModelBuilder<IAnimation> addScaleToChange(String name, float fromSx, float
