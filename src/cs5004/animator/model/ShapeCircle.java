...
/**
 * A class representing a Circle. Its center is a Point2D double and it has a radius.
 */
...
public class ShapeCircle extends Shape {
   ...
   * @throws NullPointerException if the radius is <= 0
   * @throws IllegalArgumentException if color is null.
   */
  public ShapeCircle(String name, Color color, int appear, int disappear,
      Point2D.Double center, double radius) throws IllegalArgumentException, NullPointerException {
  ...
  public String toStringText(float thisAppear, float thisDisappear) {
    return String.format("Name: %s\nType: circle\nCenter: (%.1f,%.1f), Radius: %.1f,"
            + " Color: %s\nAppears at t=%.1fs\nDisappears at t=%.1fs\n",
        this.name, this.center.x, this.center.y,
        this.radius, this.color.toString(), thisAppear, thisDisappear);
  }
